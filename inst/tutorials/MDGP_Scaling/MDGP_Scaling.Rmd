...
**Check the working directory. This location will change in every time you run the chunk -- check it. Therefore, we will have to set our working directory explicitly in every chunk where we need to write data for subsequent exercises.**
\t
