...
progressive: true
allow_skip: true
description: "The first part of the tutorial introduced theory and a new method to scale categorical raster data, that considers information retention and representativeness of the scaled classes. This second part of the tutorial evaluates the detection of the scaled classes from remotely sensed data. Scaling of a real wetland landscape and the detection of scaled classes from Landsat data are the exercises of this tutorial"
...
Evaluate the detectability of the scaled classes from Landsat using Random forest classifier.
